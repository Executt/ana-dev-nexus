  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden gradient-hero">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBanner}
          alt="Tecnologia e recursos hídricos"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <svg
          className="absolute bottom-0 left-0 w-full h-32 text-background/5"
          viewBox="0 0 1440 320"
          preserveAspectRatio="none"
      ...
      <div className="container mx-auto px-4 relative z-10 pt-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="block text-ana-blue-bright">da ANA</span>
          </h1>

          <p
            className="text-lg md:text-xl text-primary-foreground/90 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-up"
