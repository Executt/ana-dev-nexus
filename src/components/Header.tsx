...
const menuData: MenuCategory[] = [
  ...
  },
  {
    title: "DevOps",
    items: [
      { label: "Pipelines (CI/CD)", href: "/devops/pipelines" },
      { label: "Kubernetes no OpenShift", href: "/devops/kubernetes" },
      { label: "Deploy Automatizado", href: "/devops/deploy" },
      { label: "Observabilidade", href: "/devops/observabilidade" },
      { label: "Infraestrutura como Código", href: "/devops/iac" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Data Catalog", href: "/governanca/data-catalog" },
  ...
  },
  {
    ...
    items: [
      { label: "Mapas e Geoprocessamento", href: "/recursos/mapas" },
      { label: "Dados Hidrológicos", href: "/recursos/dados" },
      { label: "Integrações com Sistemas", href: "/recursos/integracoes" },
      { label: "Sistemas Legados", href: "/recursos/legados" },
    ],
  },
  {
    title: "Ferramentas",
    items: [
      { label: "Portais Internos", href: "/ferramentas/portais" },
      { label: "Ferramentas Dev", href: "/ferramentas/dev" },
      { label: "Repositórios", href: "/ferramentas/repositorios" },
      { label: "Ambiente de Testes", href: "/ferramentas/testes" },
    ],
  },
];
