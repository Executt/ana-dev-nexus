        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-4 mb-6">
              ...
              <img alt="STI" src="/lovable-uploads/a7230ffc-ec14-483d-aa26-d6efcec559c9.png" className="h-12 w-auto brightness-0 invert opacity-75 border-none shadow-md rounded-none" />
            </div>
